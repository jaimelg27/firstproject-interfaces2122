...
public class loginadmin {
	...
	private void initialize() {
		...
		JLabel lblquienesSomos = new JLabel("Administraci\u00F3n - Iniciar Sesi\u00F3n");
		lblquienesSomos.setForeground(Color.WHITE);
		lblquienesSomos.setFont(new Font("Segoe UI Black", Font.BOLD, 40));
		lblquienesSomos.setBounds(298, 103, 628, 55);
		...
		botonlogin.setBounds(492, 283, 171, 39);
	...
	public boolean isCorrect(String dni, String password) {
		...
		try {
			...
			String querySQL="SELECT id,password FROM workers WHERE id= '"+dni+"';";
